...
namespace ApiProjeWeb.UI.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> ProductList()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7118/api/Products/ProductListWithCategory");
        ...
        public async Task<IActionResult> CreateProduct(CreateProductDto createProductDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7118/api/Products/CreateProductWithCategory", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        public async Task<IActionResult> UpdateProduct(UpdateProductDto updateProductDto)
        {
            ...
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            await client.PutAsync("https://localhost:7118/api/Products/", stringContent);
            return RedirectToAction("ProductList");
