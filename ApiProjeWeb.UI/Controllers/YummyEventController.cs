...
namespace ApiProjeWeb.UI.Controllers
{
    public class YummyEventController : Controller
    {
        ...
        public async Task<IActionResult> YummyEventList()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7118/api/YummyEvents");
        ...
        public async Task<IActionResult> CreateYummyEvent(CreateYummyEventDto createYummyEventDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7118/api/YummyEvents", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.DeleteAsync("https://localhost:7118/api/YummyEvents/" + id);
            return RedirectToAction("YummyEventList");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:7118/api/YummyEvents/" + id);
        ...
        public async Task<IActionResult> UpdateYummyEvent(UpdateYummyEventDto updateYummyEventDto)
        {
            ...
            var responseMessage = await client.PutAsync("https://localhost:7118/api/YummyEvents", stringContent);
